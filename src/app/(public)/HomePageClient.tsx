...
const heroSlides: HeroSlide[] = [
  ...
  { id: 3, title: 'Credit Cards', link: '/credit-card', image: '/images/banners/mwebCCMPGenericBanner.png' }
]
...
const loansAndCards: ProductItem[] = [
  ...
  { title: 'Credit Card', icon: CreditCard, ribbon: 'Offers', ribbonColor: 'bg-green-100 text-green-700', iconColor: 'text-blue-600', link: '/credit-card' },
  ...
  { title: 'Premium', icon: Wallet, iconColor: 'text-purple-600', link: '/credit-card' }
]
