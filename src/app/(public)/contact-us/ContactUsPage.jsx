             ...
             <div className="mt-6 space-y-8 md:mt-8">
              <div className="flex items-start -mx-2">
                ...
                <span className="mx-2 text-slate-700 truncate w-72">
                  Loanzaar Office, Siliguri, West Bengal 734006
                </span>
              </div>
              ...
              <div className="flex items-start -mx-2">
                ...
                <span className="mx-2 text-slate-700 truncate w-72">76795 87581 (Toll-free)</span>
              </div>
              ...
              <div className="flex items-start -mx-2">
                ...
                <span className="mx-2 text-slate-700 truncate w-72">info@loanzaar.in</span>
              </div>
            </div>
