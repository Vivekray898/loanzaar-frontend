  ...
  const CalculatorWidget = () => (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="hidden lg:block pt-2">
        <ProtectedCTAButton label="Refinance Now" onContinue={() => setIsFormOpen(true)} className="w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 active:scale-95 transition-all text-white px-6 py-4 rounded-xl font-bold text-base shadow-xl shadow-red-200">
    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-20 lg:pb-0 text-slate-900">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 pb-safe z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        <div className="flex items-center gap-4 max-w-md mx-auto">
          ...
          <ProtectedCTAButton label="Refinance Now" onContinue={() => setIsFormOpen(true)} className="flex items-center gap-2 bg-red-600 hover:bg-red-700 active:scale-95 transition-all text-white px-6 py-3 rounded-xl font-bold text-sm shadow-lg">
...
export default CarRefinanceClient;