    ...
    <div className="space-y-6 md:space-y-8">
      <div className="bg-slate-900 text-white p-6 rounded-2xl text-center shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-slate-800">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-purple-400">₹{(emi * tenure).toLocaleString()}</p>
            </div>
        </div>
      </div>
      ...
      <div className="hidden lg:block pt-2">
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 active:scale-95 transition-all text-white px-6 py-4 rounded-xl font-bold text-base shadow-xl shadow-purple-200"
        >
          Apply Now <ArrowRight className="w-5 h-5" />
        </button>
        <p className="text-center text-xs text-slate-400 mt-3">Tax Benefits (Sec 80E) • Pre-admission</p>
      </div>
    </div>
  );
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 pb-safe z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        <div className="flex items-center gap-4 max-w-md mx-auto">
          <div className="flex-1">
            ...
            <p className="text-lg font-bold text-slate-900">Up to ₹1 Cr</p>
          </div>
          <button 
            onClick={handleApplyClick}
