    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="hidden md:block pt-2">
        <ProtectedCTAButton
          label="Apply Now"
          onContinue={onApply}
          className="w-full flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 active:scale-95 transition-all text-white px-6 py-4 rounded-xl font-bold text-base shadow-xl shadow-emerald-200/50"
        >
