...
import { X, User, Car, Check, Loader2, MapPin, Calendar, IndianRupee, Shield } from 'lucide-react';
...
interface UsedCarLoanFormProps {
  isOpen: boolean;
  onClose: () => void;
  loanType?: string;
}

export default function UsedCarLoanForm({ 
  isOpen, 
  onClose, 
  loanType = 'Used Car Loan' 
}: UsedCarLoanFormProps) {
  ...
  const handleFinalSubmit = async () => {
    if (!formData.vehicleModel || !formData.loanAmount || !formData.pincode) {
    ...
    try {
      ...
      console.log('📤 Submitting Used Car Loan application...', { mobile: payload.mobile });
      ...
      <div className="w-full max-w-lg bg-white md:rounded-3xl rounded-t-3xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col animate-in slide-in-from-bottom-10 duration-300">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white sticky top-0 z-10">
          <div>
            ...
            <p className="text-xs text-slate-500">Drive your dream car today</p>
          </div>
          <button 
            onClick={onClose} 
          ...
          {step === 1 && (
            <div className="space-y-5">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-slate-500">We need this to verify your eligibility.</p>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-5">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-slate-500">Tell us about the car you wish to buy.</p>
              </div>
