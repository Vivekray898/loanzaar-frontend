...
const HomeApplicationForm: React.FC<HomeApplicationFormProps> = ({ 
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      console.log('📤 Submitting home application...', { mobile: payload.mobile });
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button 
                  ...
                  className="flex-[2] bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-200 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
