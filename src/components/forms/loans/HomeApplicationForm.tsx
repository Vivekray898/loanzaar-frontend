...
interface HomeApplicationFormProps {
  isOpen: boolean;
  onClose: () => void;
  loanType?: string;
}

const HomeApplicationForm: React.FC<HomeApplicationFormProps> = ({ 
  isOpen, 
  onClose, 
  loanType = "Home Loan" 
}) => {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      console.log('📤 Submitting home application...', payload);
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar">
          ...
          {step === 1 && (
            <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 bg-slate-50 border ${phoneError ? 'border-red-500' : 'border-slate-200'} rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all font-medium`}
                  />
                </div>
              ...
              <button 
                onClick={nextStep} 
                className="w-full mt-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-200 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
              >
          ...
          {step === 2 && (
            <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button onClick={nextStep} className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-200 active:scale-[0.98] transition-all flex items-center justify-center gap-2">
          ...
          {step === 3 && (
            <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
              <div className="text-center mb-6">
                ...
                <h4 className="text-xl font-bold text-slate-900">Property / Residence</h4>
                <p className="text-sm text-slate-500">We need your current address for verification.</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input name="city" value={formData.city} onChange={handleInputChange} placeholder="City" className="w-full pl-9 pr-3 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all font-medium" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5 ml-1">Pincode</label>
                  <input name="pincode" type="number" maxLength={6} value={formData.pincode} onChange={handleInputChange} placeholder="000000" className="w-full p-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all font-medium" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input name="state" value={formData.state} onChange={handleInputChange} placeholder="State" className="w-full pl-9 pr-3 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all font-medium" />
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button 
                  ...
                  disabled={isLoading} 
                  className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-200 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
