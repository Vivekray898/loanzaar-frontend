        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-8 relative">
              ...
              <h2 className="text-3xl font-bold text-white mb-2">Personal Loan Inquiry Form</h2>
            ...
            <div className="p-8">
              {!submitted ? (
                <>
                  ...
                  <div className="mb-8">
                    <div className="flex justify-between mb-3">
                      {['Personal Info', 'Loan Details', 'Income & Consent'].map((step, index) => (
                        <div key={index} className="flex-1 flex flex-col items-center px-2">
                          <div className="flex items-center mb-2 w-full">
                            <div className={`flex-1 h-1 rounded-full transition-all ${currentStep > index ? 'bg-green-500' : currentStep === index ? 'bg-blue-600' : 'bg-gray-300'}`} />
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm mx-2 transition-all ${currentStep > index ? 'bg-green-500 text-white' : currentStep === index ? 'bg-blue-600 text-white' : 'bg-gray-300 text-gray-600'}`}>
                      ...
                      <div className="space-y-5">
                        ...
                        <div>
                          ...
                          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg mb-3 border border-blue-200">
                            ...
                            <p className="text-sm text-gray-600 mt-1">₹50,000 - ₹40,00,000</p>
                          </div>
                          <input 
                            type="range" 
                            min="50000" 
                        ...
                        <div>
                          ...
                          <input 
                            type="text" 
                            placeholder="e.g., Home Renovation, Medical Expenses, etc."
                    ...
                    {currentStep === 2 && (
                      <div className="space-y-5">
                        <div className="flex items-center space-x-3 mb-6">
                          ...
                          <h3 className="text-xl font-semibold text-gray-900">Income & Verification</h3>
                        </div>
                        ...
                        <div>
                          <label className="block text-sm font-semibold text-gray-700 mb-2">
                            Credit Score <span className="text-gray-400">(300-900, Optional)</span>
                          </label>
                          <input 
                            type="number" 
                            placeholder="e.g., 750"
                            ...
                            onChange={(e) => {
                              const val = e.target.value ? Math.min(Math.max(parseInt(e.target.value), 0), 900) : '';
                              setFormData({...formData, creditScore: val});
                              if (fieldErrors.creditScore) {
                                setFieldErrors({...fieldErrors, creditScore: ''});
                              }
                            }}
                            className={`w-full px-4 py-3 rounded-lg border-2 transition-all focus:outline-none ${
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                          <label className="flex items-start cursor-pointer">
                            ...
                            <span className="ml-3 text-sm text-gray-700">
                              I agree to be contacted via <span className="font-semibold">call, SMS, or WhatsApp</span> regarding my loan inquiry. I understand and acknowledge the terms and conditions.
                            </span>
                          </label>
                        </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-lg text-gray-600 mb-2">Thank you for your inquiry</p>
                  <p className="text-gray-500 mb-6">Our team will review your details and contact you shortly</p>
                  <button 
                    onClick={closeModal} 
