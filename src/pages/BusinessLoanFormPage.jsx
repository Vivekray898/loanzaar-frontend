    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-blue-100 py-20 px-6 md:px-16 flex items-center">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 max-w-lg">Get a convenient Business Loan to cover assets and expand seamlessly. Our quick application process and flexible options are designed to help your business thrive.</p>          </div>
      ...
      <section className="py-20 px-6 md:px-16 bg-gradient-to-r from-blue-600 to-blue-800">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-8">Apply for Your Business Loan Today and fuel your business growth!</p>        </div>
      </section>
    </div>
  );
};
