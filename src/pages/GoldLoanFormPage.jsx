  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pb-14 text-slate-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 px-4 h-14 flex items-center justify-between">
        ...
        <h1 className="text-sm font-bold text-slate-900">Gold Loan</h1>
        <div className="w-8"></div>
      </nav>

      {/* 2. Compact Hero Card */}
      <div className="p-4">
        <div className="bg-gradient-to-br from-yellow-500 to-amber-600 rounded-3xl p-6 text-white shadow-xl shadow-amber-200 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl font-bold leading-tight mb-2">
              Turn your Gold <br/> into <span className="text-yellow-100">Capital.</span>
            </h2>
            <p className="text-amber-50 text-sm mb-6 leading-relaxed">
              Get funds in 30 mins. Your gold stays safe in secure vaults.
            </p>
            
            <div className="flex gap-3 text-xs font-medium">
              <div className="flex items-center gap-1.5 bg-black/20 px-3 py-1.5 rounded-full">
                <Shield className="w-3 h-3 text-white" /> 100% Insured
              </div>
              <div className="flex items-center gap-1.5 bg-black/20 px-3 py-1.5 rounded-full">
                <Check className="w-3 h-3 text-white" /> No Income Proof
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  A secured loan where you pledge gold ornaments as collateral. It is the fastest way to get cash without selling your assets.
                </p>
              </div>

              <div className="bg-amber-50 p-4 rounded-xl border border-amber-100">
                <h3 className="text-sm font-bold text-amber-900 mb-3 uppercase tracking-wide">Key Benefits</h3>
                <div className="grid grid-cols-2 gap-3">
                   {[
                     ...
                     <div key={i} className="bg-white p-3 rounded-lg border border-amber-50 shadow-sm">
                        <p className="text-[10px] text-slate-400 font-bold uppercase">{stat.title}</p>
                        <p className="text-sm font-bold text-amber-700">{stat.val}</p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {features.map((feat) => (
                <div key={feat.id} className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex flex-col items-center text-center">
                  <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm mb-3 text-amber-600">
            ...
            <div className="space-y-4">
              <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex gap-3">
                ...
                <p className="text-xs text-orange-800 leading-relaxed">
                  Only Identity and Address proof required. No income proof needed.
                </p>
              </div>
