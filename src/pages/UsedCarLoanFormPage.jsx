...
import { 
  ...
  TrendingUp, Calendar, Briefcase, User, Users
} from 'lucide-react';
...
const UsedCarLoanFormPage = () => {
  ...
  const faqs = [
    ...
    { q: 'Loan tenure?', a: 'Typically 12 to 72 months.' },
    { q: 'Can any car be financed?', a: 'Usually cars up to 15 years old at loan maturity.' },
    { q: 'Down payment?', a: 'Initial amount paid upfront to reduce loan burden.' },
    { q: 'Credit score needed?', a: 'Ideally 680+ for better rates and approval.' },
    { q: 'New vs Used loan?', a: 'Used loans have slightly higher rates and stricter eligibility.' }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pb-4 text-slate-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 px-4 h-14 flex items-center justify-between">
        ...
        <h1 className="text-sm font-bold text-slate-900">Used Car Loan</h1>
        ...
        <div className="bg-gradient-to-br from-red-600 to-rose-700 rounded-3xl p-6 text-white shadow-xl shadow-red-200 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl font-bold leading-tight mb-2">
              Upgrade your ride <br/> <span className="text-red-100">affordably.</span>
            </h2>
            <p className="text-red-50 text-sm mb-6 leading-relaxed">
              Loans up to ₹47 Lakhs for used cars with quick approval.
            </p>
            
            <div className="flex gap-3 text-xs font-medium">
              <div className="flex items-center gap-1.5 bg-black/20 px-3 py-1.5 rounded-full">
                <Zap className="w-3 h-3 text-yellow-400 fill-yellow-400" /> Fast Process
              </div>
              <div className="flex items-center gap-1.5 bg-black/20 px-3 py-1.5 rounded-full">
                <Settings className="w-3 h-3 text-white" /> Flexible Terms
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  Secure a loan with lower interest rates to finance your used car purchase affordably. Get up to 100% financing based on valuation.
                </p>
                <div className="grid grid-cols-2 gap-3">
                   <div className="bg-red-50 p-3 rounded-xl border border-red-100">
                      <h4 className="text-xs font-bold text-red-800 mb-1">Max Funding</h4>
                      <p className="text-[10px] text-red-600 leading-tight">High LTV available.</p>
                   </div>
                   <div className="bg-red-50 p-3 rounded-xl border border-red-100">
                      <h4 className="text-xs font-bold text-red-800 mb-1">Ownership</h4>
                      <p className="text-[10px] text-red-600 leading-tight">Drive immediately.</p>
                   </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex gap-3">
                ...
                <p className="text-xs text-orange-800 leading-relaxed">
                  Valuation report of the car might also be required.
                </p>
              </div>
